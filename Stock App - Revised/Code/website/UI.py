...
headers = {
	"X-RapidAPI-Key": "ee1be047f7msh6262b39c4d93dddp18bae6jsn11588701e383",
    ...
    def search(self):
        if request.method == "POST":
            ...
            if form == "search":
                ...
                for stock in self.stocks:
                    if stock.sameStock(stock_name):
                        if current_user.is_authenticated:
                            ...
                            return render_template("search.html", user=current_user, stock=stock, watchlist=in_watchlist, price_30_days=json.dumps(stock.price_30_days))
                        else:
                            return render_template("search.html", user=current_user, stock=stock, price_30_days=json.dumps(stock.price_30_days))
                ...
                flash('Stock removed from the watchlist successfully', category='success')
